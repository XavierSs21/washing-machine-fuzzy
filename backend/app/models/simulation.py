...
class SimulationRequest(BaseModel):
    tipo_ropa: float = Field(..., ge=0, le=100, description="0=delicada, 50=normal, 100=resistente")
    nivel_suciedad: float = Field(..., ge=0, le=100, description="0=baja, 50=media, 100=alta")
