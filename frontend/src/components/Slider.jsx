import { UI_COLORS } from "../hooks/canvasUtils";
  ...
  return (
    <div style={{ marginBottom: 18 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 6 }}>
        <span style={{
          fontSize: 11, color: "#777", letterSpacing: "0.08em",
        ...
        <span style={{ fontSize: 14, color, fontFamily: "monospace", fontWeight: 700 }}>
          {value}{unit}{" "}
          <span style={{ fontSize: 10, color: "#666" }}>{sublabel(value)}</span>
        </span>
      </div>

      <div style={{
        position: "relative", height: 8,
        background: UI_COLORS.surfaceLight, borderRadius: 6, cursor: "pointer",
      }}>
        <div style={{
          position: "absolute", left: 0, top: 0, height: "100%",
          width: `${pct}%`, background: color, borderRadius: 6, transition: "width 0.1s",
        }} />
        <input
